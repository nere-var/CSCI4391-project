...
#   (id,   player_id,                  "name",      "category",   quantity,      unit,      "measurement_type",   quantity_grams,   quantity_ml,     "purchase_date",    "best_by", raw_meat, perishable, opened, donation_allowed, decompostion_flag,     price,      "status")
    ...
    (31,            1,     'Crushed Tomatoes',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (44,            1,            'Anchovies',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    (45,            1,               'Capers',        'Pantry',        100,       'g',                'weight',              100,          None,        '2026-02-20', '2027-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
    (46,            1,   'Sun-Dried Tomatoes',        'Pantry',        150,       'g',                'weight',              150,          None,        '2026-02-20', '2027-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
    (47,            1,     'Artichoke Hearts',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    (48,            1,            'Mushrooms',       'Produce',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2026-02-27',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (51,            1,    'Red Pepper Flakes',        'Pantry',         20,       'g',                'weight',               20,          None,        '2026-02-20', '2028-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
    (52,            1, 'Italian Bread Crumbs',        'Pantry',        300,       'g',                'weight',              300,          None,        '2026-02-20', '2027-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
    (53,            1,           'Mascarpone',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2026-03-05',        0,          1,      0,                1,                 0,         0,      'active'),
    (54,            1, 'Pinto Beans (Canned)',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    (55,            1,        'Refried Beans',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    (56,            1,   'Jalapeños (Canned)',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-20', '2028-02-20',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (59,            1,                'Limes',       'Produce',          4,   'count',                 'count',             None,          None,        '2026-02-20', '2026-03-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (60,            1,             'Avocados',       'Produce',          2,   'count',                 'count',             None,          None,        '2026-02-20', '2026-02-27',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (63,            1,  'Corn Tortilla Chips',         'Snack',        300,       'g',                'weight',              300,          None,        '2026-02-20', '2027-02-20',        0,          0,      0,                1,                 0,         0,      'active')
]


sample_items_2 = [
    (64,             2,             'Bagels',         'Bakery',          1,      'pack',               'count',             None,          None,        '2026-02-10', '2026-02-18',         0,         1,     0,                 1,                 0,         0,         'active'),
    ...
    (67,             2,     'Chicken Thighs',           'Meat',          2,        'lb',              'weight',             None,          None,        '2026-02-14', '2026-02-19',         1,         1,     0,                 1,                 0,         0,         'active'),
