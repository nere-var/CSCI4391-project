...
#   (id,   player_id,                  "name",      "category",   quantity,      unit,      "measurement_type",   quantity_grams,   quantity_ml,     "purchase_date",    "best_by", raw_meat, perishable, opened, donation_allowed, decompostion_flag,     price,      "status")
    ( 1,            1,            'Tortilla',        'Bakery',          1,   'count',                 'count',             None,          None,        '2026-02-09', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ( 2,            1,                'Bread',        'Bakery',          1,    'loaf',                 'count',             None,          None,        '2026-02-10', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    ( 6,            1,         'Tomato Sauce',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-01', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ( 7,            1,        'Corn (Canned)',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-01', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ( 8,            1, 'Black Bean (Canned)',        'Canned',          1,     'can',                 'count',             None,          None,        '2026-02-01', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (11,            1,         'Strawberry',       'Produce',        200,       'g',                'weight',              200,          None,        '2026-02-10', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (12,            1,              'Banana',       'Produce',          4,   'count',                 'count',             None,          None,        '2026-02-09', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (13,            1,               'Onion',       'Produce',        300,       'g',                'weight',              300,          None,        '2026-02-06', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (14,            1,             'Potato',       'Produce',        500,       'g',                'weight',              500,          None,        '2026-02-07', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (15,            1,              'Carrot',       'Produce',        300,       'g',                'weight',              300,          None,        '2026-02-08', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (16,            1,         'Greek Yogurt',         'Dairy',        150,       'g',                'weight',              150,          None,        '2026-02-12', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (17,            1,       'Cheddar Cheese',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-11', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (18,            1,                 'Egg',         'Dairy',         12,   'count',                 'count',             None,          None,        '2026-02-10', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (19,            1,           'Pork Chop',          'Meat',          2,      'lb',                'weight',             None,          None,        '2026-02-13', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (20,            1,          'Ground Beef',          'Meat',          1,      'lb',                'weight',             None,          None,        '2026-02-14', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (21,            1,              'Spinach',       'Produce',        100,       'g',                'weight',              100,          None,        '2026-02-05', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (22,            1,                 'Milk',         'Dairy',         16,   'fl_oz',                'volume',             None,            16,        '2026-02-10', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (23,            1,       'Chicken Breast',          'Meat',          2,      'lb',                'weight',             None,          None,        '2026-02-15', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (24,            1,      'Parmesan Cheese',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (25,            1,    'Mozzarella Cheese',         'Dairy',        250,       'g',                'weight',              250,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (26,            1,       'Ricotta Cheese',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (27,            1,        'Basil (Fresh)',       'Produce',         30,       'g',                'weight',               30,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (28,            1,      'Oregano (Dried)',        'Pantry',         20,       'g',                'weight',               20,          None,        '2026-02-20', '2027-01-01',        0,          0,      0,                1,                 0,         0,      'active'),
    (29,            1,        'Thyme (Dried)',        'Pantry',         20,       'g',                'weight',               20,          None,        '2026-02-20', '2028-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
    (30,            1,               'Garlic',       'Produce',        100,       'g',                'weight',              100,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (41,            1,      'Italian Sausage',          'Meat',          1,      'lb',                'weight',             None,          None,        '2026-02-20', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (42,            1,           'Prosciutto',          'Meat',        150,       'g',                'weight',              150,          None,        '2026-02-20', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (43,            1,               'Salami',          'Meat',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    ...
    (48,            1,            'Mushroom',       'Produce',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (49,            1,             'Zucchini',       'Produce',        300,       'g',                'weight',              300,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (50,            1,             'Eggplant',       'Produce',        400,       'g',                'weight',              400,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (53,            1,           'Mascarpone',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    ...
    (59,            1,                'Lime',       'Produce',          4,   'count',                 'count',             None,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (60,            1,             'Avocado',       'Produce',          2,   'count',                 'count',             None,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (61,            1,         'Queso Fresco',         'Dairy',        200,       'g',                'weight',              200,          None,        '2026-02-20', '2027-01-01',        0,          1,      0,                1,                 0,         0,      'active'),
    (62,            1,              'Chorizo',          'Meat',          1,      'lb',                'weight',             None,          None,        '2026-02-20', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
    (63,            1,  'Corn Tortilla Chip',         'Snack',        300,       'g',                'weight',              300,          None,        '2026-02-20', '2027-02-20',        0,          0,      0,                1,                 0,         0,      'active')
]


sample_items_2 = [
    (64,             2,             'Bagel',         'Bakery',          1,      'pack',               'count',             None,          None,        '2026-02-10', '2027-01-01',         0,         1,     0,                 1,                 0,         0,         'active'),
    (65,             2,             'Cereal',         'Pantry',        300,         'g',              'weight',              300,          None,        '2026-01-20', '2027-01-20',         0,         1,     0,                 1,                 0,         0,         'active'),
    (66,             2,        'Apple Juice',       'Beverage',         32,     'fl_oz',              'volume',             None,            32,        '2026-02-05', '2027-01-01',         0,         1,     0,                 1,                 0,         0,         'active'),
    (67,             2,     'Chicken Thigh',           'Meat',          2,        'lb',              'weight',             None,          None,        '2026-02-14', '2027-01-01',         1,         1,     0,                 1,                 0,         0,         'active'),
    (68,             2,            'Lettuce',        'Produce',        150,         'g',              'weight',              150,          None,        '2026-02-09', '2027-01-01',         0,         1,     0,                 1,                 0,         0,         'active')
...
#   (id,   player_id,                  "name",      "category",   quantity,      unit,      "measurement_type",   quantity_grams,   quantity_ml,     "purchase_date",    "best_by", raw_meat, perishable, opened, donation_allowed, decompostion_flag,     price,      "status")
    ...
    (114,           4,     'Sun-Dried Tomato',        'Pantry',        150,       'g',                'weight',              150,          None,        '2026-02-20', '2025-02-20',        0,          0,      0,                1,                 0,         0,      'active'),
...
sample_items_5 = [
    (132,           5,              'Tortilla',       'Bakery',          1,    'count',                 'count',            None,          None,      '2026-02-09',   '2027-01-01',       0,        1,      0,             1,                  0,              0,      'active'),
    (133,           5,                  'Bread',             'Bakery',   1,   'loaf',                   'count',            None,           None,       '2026-02-10', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (134,           5,                  'Sugar',             'Pantry', 500,   'g',                      'weight',           500,            None,       '2026-01-12', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (135,           5,                  'Salt',              'Pantry', 250,   'g',                      'weight',           250,            None,       '2026-01-10', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (136,           5,              'Olive Oil',            'Pantry', 500,   'ml',                      'volume',           None,           500,        '2026-01-15', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (137,           5,          'Tomato Sauce',             'Canned',   1,   'can',                     'count',            None,           None,       '2026-02-01', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (138,           5,          'Corn (Canned)',            'Canned',   1,   'can',                     'count',            None,           None,       '2026-02-01', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (139,           5,    'Black Bean (Canned)',            'Canned', 1,    'can',                      'count',            None,           None,       '2026-02-01', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (140,           5,                  'Pasta',             'Grains', 500,   'g',                      'weight',           500,            None,       '2026-01-25', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (141,           5,                  'Rice',              'Grains',1000,   'g',                      'weight',           1000,           None,       '2026-01-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (142,           5,              'Strawberry',            'Produce',200,   'g',                      'weight',           200,            None,       '2026-02-10', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (143,           5,                  'Banana',            'Produce',  4,   'count',                  'count',            None,           None,       '2026-02-09', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (144,           5,                  'Onion',             'Produce',300,   'g',                      'weight',           300,            None,       '2026-02-06', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (145,           5,                  'Potato',            'Produce',500,   'g',                      'weight',           500,            None,       '2026-02-07', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (146,           5,                  'Carrot',            'Produce',300,   'g',                      'weight',           300,            None,       '2026-02-08', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (147,           5,              'Greek Yogurt',          'Dairy',  150,   'g',                      'weight',           150,            None,       '2026-02-12', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (148,           5,          'Cheddar Cheese',           'Dairy',  200,   'g',                       'weight',           200,            None,       '2026-02-11', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (149,           5,                  'Egg',               'Dairy',   12,   'count',                  'count',            None,           None,       '2026-02-10', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (150,           5,                  'Spinach',           'Produce',100,   'g',                      'weight',           100,            None,       '2026-02-05', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (151,           5,                      'Milk',            'Dairy',   16,   'fl_oz',                'volume',           None,           16,         '2026-02-10', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (152,           5,              'Parmesan Cheese',        'Dairy',  200,   'g',                     'weight',           200,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (153,           5,              'Mozzarella Cheese',      'Dairy',  250,   'g',                     'weight',           250,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (154,           5,              'Ricotta Cheese',         'Dairy',  200,   'g',                  'weight',              200,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (155,           5,              'Basil (Fresh)',          'Produce', 30,   'g',                     'weight',           30,             None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (156,           5,              'Oregano (Dried)',        'Pantry',  20,   'g',                     'weight',           20,             None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (157,           5,              'Thyme (Dried)',          'Pantry',  20,   'g',                     'weight',           20,             None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (158,           5,              'Garlic',                 'Produce',100,   'g',                     'weight',           100,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (159,           5,              'Crushed Tomato',         'Canned',   1,   'can',                   'count',            None,           None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (160,           5,              'Tomato Paste',        'Canned',   1,       'can',                  'count',            None,           None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (161,           5,             'Pesto Sauce',       'Pantry', 200,          'g',                    'weight',           200,            None,       '2026-02-20', '2027-02-20', 0, 1, 0, 1, 0, 0, 'active'),
    (162,           5,              'Balsamic Vinegar',  'Pantry', 250,         'ml',                   'volume',           None,           250,        '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (163,           5,              'Red Wine Vinegar',  'Pantry', 250,         'ml',                   'volume',           None,           250,        '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (164,           5,                  'Spaghetti',         'Grains', 500,   'g',                      'weight',           500,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (165,           5,                  'Fettuccine',        'Grains', 500,   'g',                      'weight',           500,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (166,           5,                  'Penne Pasta',       'Grains', 500,   'g',                      'weight',           500,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (167,           5,                  'Arborio Rice',      'Grains', 500,   'g',                      'weight',           500,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (168,           5,             'Polenta (Cornmeal)',    'Grains', 500,   'g',                       'weight',           500,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (169,           5,               'Red Pepper Flake',    'Pantry',  20,   'g',                       'weight',           20,             None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (170,           5,              'Italian Bread Crumb',  'Pantry',300,   'g',                        'weight',           300,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    ...
    (173,           5,                  'Mushroom',          'Produce',200,   'g',                      'weight',           200,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (174,           5,                  'Zucchini',          'Produce',300,   'g',                      'weight',           300,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (175,           5,                  'Eggplant',          'Produce',400,   'g',                      'weight',           400,            None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (176,           5,                  'Cilantro',          'Produce', 30,   'g',                      'weight',           30,             None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (177,           5,                      'Lime',          'Produce',  4,   'count',                  'count',            None,           None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (178,           5,                  'Avocado',           'Produce',  2,   'count',                  'count',            None,           None,       '2026-02-20', '2027-01-01', 0, 1, 0, 1, 0, 0, 'active'),
    (179,           5,          'Corn Tortilla Chip',           'Snack',  300,   'g',                   'weight',           300,            None,       '2026-02-20', '2027-01-01', 0, 0, 0, 1, 0, 0, 'active'),
    (180,           5,          'Ground Beef',                      'Meat',  1,    'lb',                'weight',           None,          None,        '2027-02-14', '2027-01-01',        1,          1,      0,                1,                 0,         0,      'active'),
